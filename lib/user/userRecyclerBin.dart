...
class UserRecyclerBin extends StatefulWidget {
  const UserRecyclerBin({Key? key}) : super(key: key);

  @override
  State<UserRecyclerBin> createState() => _UserRecyclerBinState();
}

class _UserRecyclerBinState extends State<UserRecyclerBin> {
...
class SearchResult extends SearchDelegate {
  ...
  Widget buildSuggestions(BuildContext context) {
    return Center(child: Text("نتائج البحث"));
  }
}
